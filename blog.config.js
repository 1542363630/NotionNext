...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'a3eb7068e2f34557acd7c8899b3a6a45,en:a3eb7068e2f34557acd7c8899b3a6a45',
  ...
  GREETING_WORDS:
    ...
    '零散的 blog 们,和它们蒟蒻的创造者🫠,向您致敬🫡,🎉欢迎你的到来🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'fivey', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'SDUer,ACMer,Coder', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yangshiyu10.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yangshiyu100@outlook.com', // 邮箱地址 例如mail@tangly1024.com
